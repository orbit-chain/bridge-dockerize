...
class STACKSValidator {
    ...
    async validateRelayedData(data) {
        ...
        transaction.events.forEach(e => {
            ...
            if (stacksAddrs.deploy_address.toLowerCase() !== deployer.toLowerCase()) {
    ...
    async validateSwap(data, params){
        ...
        if(!stacksAddrs || !stacksAddrs.deploy_address) return;
