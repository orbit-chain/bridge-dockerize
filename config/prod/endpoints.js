module.exports = {
    ...
    endpoints : {
        ...
        klaytn: {
            ...
            rpc: ["https://public-en-cypress.klaytn.net", "https://klaytn-mainnet-rpc.allthatnode.com:8551", "https://public-node-api.klaytnapi.com/v1/cypress"],
            confirm: 10
        },
        matic: {
    ...
    VALIDATOR_MONITOR: {
        ozys: {
            monitor: "https://va.bridge.orbitchain.io.dev.ozys.work/governance/report",
            orbit: "https://api.bridge.orbitchain.io.dev.ozys.work",
            validator: "https://va.bridge.orbitchain.io.dev.ozys.work/",
